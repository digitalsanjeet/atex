...
SCENES = {
    ...
    "rural_map": "Create rural American community map with a nearby dollar store and distant major retailer.",
    "five_and_dime": "Create historical American five-and-dime or 1950s dollar-store scene.",
    "chains_map": "Create small dollar store contrasted with large retail chains on a simple American map.",
